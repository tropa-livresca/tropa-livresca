...
router.get("/principal", checkAuth, EnderecoController.BuscarEnderecoPrincipal);
...
router.patch("/:id/principal", checkAuth, EnderecoController.DefinirEnderecoPrincipal);
